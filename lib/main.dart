...
class _CurrencyConverterState extends State<CurrencyConverter> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
            '                                                                                            Conversor Monetario / Beatriz de Oliveira - 2°C '),
        backgroundColor: Color.fromARGB(255, 220, 216, 0),
      ),
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              ...
              style: TextStyle(
                  fontSize: 20.0, color: Color.fromARGB(255, 247, 247, 247)),
            ),
            SizedBox(height: 20.0),
            Text(
            ...
            SizedBox(height: 20.0),
            Text('Euros: ${_euros.toStringAsFixed(2)}',
                textAlign: TextAlign.center,
                style: TextStyle(
                    fontSize: 20.0, color: Color.fromARGB(255, 255, 255, 255))),
          ],
